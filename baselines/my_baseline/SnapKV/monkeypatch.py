...
from.qwen2_hijack_4_43 import qwen2_flash_attn2_forward as qwen2_flash_attn2_forward_4_43
def check_version():
    try:
...
def replace_qwen():
    ...
    transformers.models.qwen2.modeling_qwen2.Qwen2FlashAttention2.forward = qwen2_flash_attn2_forward_4_43
