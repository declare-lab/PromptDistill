...
from transformers.models.qwen2.modeling_qwen2 import Qwen2Config,Cache,Union,List,Unpack,FlashAttentionKwargs,KwargsForCausalLM,Qwen2RotaryEmbedding,Qwen2MLP,Qwen2RMSNorm,DynamicCache,StaticCache,apply_rotary_pos_emb,repeat_kv,logger,eager_attention_forward,repeat_kv
...
class SelectiveQwen2Model(Qwen2PreTrainedModel):
    """
...
class PromptDistill(Qwen2PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = SelectiveQwen2Model(config)
        self.vocab_size = config.vocab_size
